...
static __attribute__((unused)) void BSP_EPIT_stop(EPIT_Type* EPIT) {
...
void EPIT_Init(void) {
    ...
    EPITconfig.LoadRegister = 66000000;              /*Load register */
    EPITconfig.CompareRegister = 33000000;           /*Compare register */
    // 初始化EPIT1外设
